...
explicit_Wait = WebDriverWait(driver, 10, 1)
...
explicit_Wait.until(expected_conditions.text_to_be_present_in_element((By.XPATH, "//div[@aria-labelledby='ui-id-3']/p"),"Sed non urna. Donec et ante"))
